...
import {
  ...
  hmac,
  mapToCurveSimpleSWU
} from "./chunk-DWUULYW7.js";
import {
  AccountNotFoundError,
  formatLog,
  formatTransactionReceipt
} from "./chunk-T6VQHVCI.js";
import {
  BaseError,
...
function pointG2ToBytes(_c, point, isComp) {
  ...
  if (isComp) {
    if (is0)
      return concatBytes(COMPZERO, numberToBytesBE(_0n8, L));
    const flag = Boolean(y.c1 === _0n8 ? y.c0 * _2n6 / P : y.c1 * _2n6 / P);
...
function pointG2FromBytes(bytes) {
  ...
  if (value.length === 96 && compressed) {
    ...
    const Y_bit = y.c1 === _0n8 ? y.c0 * _2n6 / P : y.c1 * _2n6 / P ? _1n8 : _0n8;
...
function signatureG2FromBytes(hex2) {
  ...
  const isGreater = y1 > _0n8 && y1 * _2n6 / P !== aflag1;
  const is0 = y1 === _0n8 && y0 * _2n6 / P !== aflag1;
  if (isGreater || is0)
    y = Fp2.neg(y);
  const point = Point2.fromAffine({ x, y });
  point.assertValidity();
...
@noble/curves/esm/p256.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-QQHIXIGB.js.map
