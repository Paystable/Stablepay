...
export default function Investors() {
  ...
  const riskFactors = [
    ...
    },
    {
      ...
      mitigation: "Financial Intelligence Unit-India Registered with proactive regulatory compliance"
    },
    {
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="brand-text no-blur">
                          Financial Intelligence Unit-India Registered with full AML/KYC compliance. Transparent operations 
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="brand-text no-blur">Financial Intelligence Unit-India Registered compliance reporting</span>
                        </div>
                        <div className="flex items-center gap-2">
